...
def generate_outputs(img_path):
    ...
    result = open("C:\\Users\\saibalaji\\Desktop\\Hash it out\\flask-app-run\\labels.txt", 'r').readlines()
    treatment = open("C:\\Users\\saibalaji\\Desktop\\Hash it out\\flask-app-run\\solutions.txt", 'r').readlines()
    ...
    if 'file' in request.files:
        ...
        if file and allowed_file(file.filename):
            ...
            # Call a function to generate the three outputs (output1, output2, output3)
                ...
                response_data = {
                    "Plant name": "Invalid image",
                    "confident score": "Invalid image",
                    "treatment": "Invalid image"
                }
                return jsonify(response_data)
        else:
